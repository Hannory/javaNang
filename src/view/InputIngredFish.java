...
public class InputIngredFish extends JPanel {
	...
	public InputIngredFish(MainFrame mf) {
		...
		Image imgBtn1 = new ImageIcon("images/sim/btnImg/fishBtnImg/fish01.PNG").getImage().getScaledInstance(145, 230, 0);
		...
		Image imgBtn2 = new ImageIcon("images/sim/btnImg/fishBtnImg/fish02.PNG").getImage().getScaledInstance(145, 230, 0);
		...
		Image imgBtn3 = new ImageIcon("images/sim/btnImg/fishBtnImg/fish03.PNG").getImage().getScaledInstance(145, 230, 0);
		...
		Image imgBtn4 = new ImageIcon("images/sim/btnImg/fishBtnImg/fish04.PNG").getImage().getScaledInstance(145, 230, 0);
		...
		Image imgBtn5 = new ImageIcon("images/sim/btnImg/fishBtnImg/fish05.PNG").getImage().getScaledInstance(145, 230, 0);
		...
		Image imgBtn6 = new ImageIcon("images/sim/btnImg/fishBtnImg/fish06.PNG").getImage().getScaledInstance(145, 230, 0);
		...
		Image imgBtn7 = new ImageIcon("images/sim/btnImg/fishBtnImg/fish07.PNG").getImage().getScaledInstance(145, 230, 0);
		...
		Image imgBtn8 = new ImageIcon("images/sim/btnImg/fishBtnImg/fish08.PNG").getImage().getScaledInstance(145, 230, 0);
		...
		Image imgBtn9 = new ImageIcon("images/sim/btnImg/fishBtnImg/fish09.PNG").getImage().getScaledInstance(145, 230, 0);
