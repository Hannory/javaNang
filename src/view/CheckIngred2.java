...
public class CheckIngred2 extends JPanel{
	...
	public CheckIngred2(MainFrame mf) {
		...
		JLabel barTitle = new JLabel("재료확인 <2>");
		...
		Image imgBtn1 = new ImageIcon("images/sim/BtnImg/"+ sarr[9] +".PNG").getImage().getScaledInstance(145, 200, 0);
		...
		Image imgBtn2 = new ImageIcon("images/sim/BtnImg/" + sarr[10] +".PNG").getImage().getScaledInstance(145, 200, 0);
		...
		Image imgBtn3 = new ImageIcon("images/sim/BtnImg/" + sarr[11] +".PNG").getImage().getScaledInstance(145, 200, 0);
		...
		Image imgBtn4 = new ImageIcon("images/sim/BtnImg/"+ sarr[12] +".PNG").getImage().getScaledInstance(145, 200, 0);
		...
		Image imgBtn5= new ImageIcon("images/sim/BtnImg/"+ sarr[13] +".PNG").getImage().getScaledInstance(145, 200, 0);
		...
		Image imgBtn6 = new ImageIcon("images/sim/BtnImg/"+ sarr[14] +".PNG").getImage().getScaledInstance(145, 200, 0);
		...
		Image imgBtn7 = new ImageIcon("images/sim/BtnImg/"+ sarr[15] +".PNG").getImage().getScaledInstance(145, 200, 0);
		...
		Image imgBtn8 = new ImageIcon("images/sim/BtnImg/"+ sarr[16] +".PNG").getImage().getScaledInstance(145, 200, 0);
		...
		Image imgBtn9 = new ImageIcon("images/sim/BtnImg/"+ sarr[17] +".PNG").getImage().getScaledInstance(145, 200, 0);
