...
public class InputIngredMilk extends JPanel {
	...
	public InputIngredMilk(MainFrame mf) {
		...
		Image imgBtn1 = new ImageIcon("images/sim/milkBtnImg/milk01.PNG").getImage().getScaledInstance(145, 230, 0);
		...
		Image imgBtn2 = new ImageIcon("images/sim/milkBtnImg/milk02.PNG").getImage().getScaledInstance(145, 230, 0);
		...
		Image imgBtn3 = new ImageIcon("images/sim/milkBtnImg/milk03.PNG").getImage().getScaledInstance(145, 230, 0);
		...
		Image imgBtn4 = new ImageIcon("images/sim/milkBtnImg/milk04.PNG").getImage().getScaledInstance(145, 230, 0);
		...
		Image imgBtn5 = new ImageIcon("images/sim/milkBtnImg/milk05.PNG").getImage().getScaledInstance(145, 230, 0);
		...
		Image imgBtn6 = new ImageIcon("images/sim/milkBtnImg/milk06.PNG").getImage().getScaledInstance(145, 230, 0);
		...
		Image imgBtn7 = new ImageIcon("images/sim/milkBtnImg/milk07.PNG").getImage().getScaledInstance(145, 230, 0);
		...
		Image imgBtn8 = new ImageIcon("images/sim/milkBtnImg/milk08.PNG").getImage().getScaledInstance(145, 230, 0);
		...
		Image imgBtn9 = new ImageIcon("images/sim/milkBtnImg/milk09.PNG").getImage().getScaledInstance(145, 230, 0);
